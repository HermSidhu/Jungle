...
describe User, type: :model do
  describe 'Validations' do
    before(:each) do
      @user = User.new(name: "homer", email: "homer@simpson.com", password: "aaa", password_confirmation: "aaa")
    end
    ...
    it "only allows 1 email address to register" do
      @user.save
      @user1 = User.new(name: "marge", email: "homer@simpson.com", password: "aaa", password_confirmation: "aaa")
      @user1.save
  ...
  describe '.authenticate_with_credentials' do
    before(:each) do
      @user = User.create(id: 1, name: "homer", email: "homer@simpson.com", password: "aaa", password_confirmation: "aaa")
    end
